...
const PREFIX = process.env.PREFIX || ','; // Default prefix is '!'
const TOKEN = process.env.TOKEN;
const OPERATORS = Array.isArray(process.env.OPERATORS) 
    ? process.env.OPERATORS 
    : process.env.OPERATORS.includes(',')
    ? process.env.OPERATORS.split(',').map(id => id.trim()) 
    : [process.env.OPERATORS.trim()];
