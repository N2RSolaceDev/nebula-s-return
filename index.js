  ...
  try {
    switch (command) {
      ...
      case 'b':
        ...
        await Promise.all(banMembersWithRole.map(member => member.ban().catch(() => {})));
...
TypeR.login(TOKEN);import { Client, GatewayIntentBits, Events, EmbedBuilder, ChannelType } from 'discord.js';
import dotenv from 'dotenv';
import { parse } from 'ini';
import { readFileSync } from 'fs';
import ora from 'ora';
